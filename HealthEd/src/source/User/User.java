...
public class User {
    ...
    public void viewWorkshops(IFileReaderUtility fileReadUtility, String filepath, boolean upcoming) {
        String[] workshops = readFileAndSplit(fileReadUtility, filepath);
    ...
    public void viewResources(IFileReaderUtility fileReadUtility, String filepath) {
        String[] lines = readFileAndSplit(fileReadUtility, filepath);
    ...
    private String[] readFileAndSplit(IFileReaderUtility fileReadUtility, String filepath) {
