...
public class Workshop {
    ...
    public void editWorkshop(String workshopName, String filePath, IFileWriteUtility fileWriteUtility, IFileReaderUtility fileReaderUtility) {
    ...
    public void deleteWorkshop(String workshopName, String filePath, IFileReaderUtility fileReaderUtility, IFileManipulator fileManipulator) {
        if (fileReaderUtility.searchFromFile(filePath, workshopName)) {
    ...
    private String getWorkshopDetailsFromFile(String workshopName, String filePath, IFileReaderUtility fileReaderUtility) {
        String[] workshops = readFileAndSplit(filePath, fileReaderUtility);
